...
Si luego de haber aceptado cambias de opinión, puedes anular tu consentimiento para que te contactemos, por la recolección, uso o divulgación de tu información, en cualquier momento con el simple hecho de desuscribirte de nuestro mails.
...
Si eliges una pasarela de pago directo para completar tu compra, entonces Shopify almacena datos de tu tarjeta de crédito con los máximos estándares de seguridad actual. Está cifrada a través de la Seguridad Standard de Datos de la Industrai de Tarjetas de Pago (PCI-DSS). Tus datos de transacción de compra se almacenan sólo en la medida en que sea necesario para completar la transacción de compra. Después de que se haya completado, se borra la información de su transacción de compra.
...
Para una visión más clara, también puedes leer las Condiciones de servicio de Shopify o Declaración de privacidad de Shopify.

SECCIÓN 5 - SERVICIO DE TERCERAS PARTES
...
Este sitio web es operado por Print3x <Crea 3D SpA>. En todo el sitio, los términos “nosotros”, “nos” y “nuestro” se refieren a Print3x <Crea 3D SpA>. Print3x <Crea 3D SpA> ofrece este sitio web, incluyendo toda la información, herramientas y servicios disponibles para ti en este sitio, el usuario, está condicionado a la aceptación de todos los términos, condiciones, políticas y notificaciones aquí establecidos.
...
Los títulos utilizados en este acuerdo se incluyen solo por conveniencia y no limita o afecta a estos Términos de Servicio.
...
Estas Condiciones de servicio y cualquier acuerdos aparte en el que te proporcionemos servicios se regirán e interpretarán en conformidad con las leyes de Santiago, de Chile.
...
- En caso de que algo salga mal con tu producto, nosotros cambiaremos inmediatamente tu producto
- En caso de cambio de producto los gastos corren por nuestra cuenta

Nuestra política de cambio tiene una duración de 90 días. Si 90 días han pasado desde Tu compra, por desgracia no podemos ofrecer un reembolso o cambio.

Para ser elegible para una devolución porque no lo quieres, el artículo debe estar sin usar y en las mismas condiciones en que lo recibiste. También debe estar en su embalaje original.

Sí el producto te ha salido defectuoso, es decir, el filamento aumenta o disminuye su grosor, y te ha producido problemas en la impresión, lamentamos la molestia y procederemos a cambiar el filamento. Sí este es el caso nos debes enviar una foto del problema por cualquier vía y procederemos al cambio del filamento sin ningún costo (un filamento tiene la taza de fallo de 1 entre 100 unidades), así que estadísticamente debiese ir en perfectas condiciones el que te enviemos como cambio. Y para completar tu devolución, requerimos el recibo o número de compra que debe estar en tu mail.
...
- Enviaremos tu pedido a la dirección que nos indiques
- En caso de cambio de producto los gastos corren por nuestra cuenta

Currier

Los costos de envío calculados son los valores promedio de nuestro currier de despacho usado, estos currier pueden variar y están sujetos a cambios por parte de la empresa Print3x <Crea 3D SpA>

Tiempos de envió

Los tiempos de envió son de un margen que maneja la empresa de despacho, sí llega a demorar más de lo estipulado en el tiempo de envió dicho por nuestra web puede ver en que estado esta su envió en el seguimiento que ofrece nuestra web.

Sí demoró más de lo habitual el envío puede deberse a situaciones fortuitas y no necesariamente al estándar de tiempos de nuestro currier.
